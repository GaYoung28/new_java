...
public class MemberController {
    ...
    public String create2(MemberVO memberVO, Model model) {
        ...
        //이 메서드 실행할 때만 필요하기 때문에
        // 이 메서드의 파라메터로 선언하면 스프링이 찾아서 주소를 넣어줌
        //model 변수에 200번에 있더라.라고 주소를 넣어줌
        //객체(부품)은 주소만 알면 객체의 기능(메서드)을 쓸 수 있다.
        //html에 전달할 값 지정하자.!!!
//        model.addAttribute("id", memberVO.getId());//여러 개 넘길 수 있다
//        model.addAttribute("pw", memberVO.getPw());
    ...
    //public String create2(String id, String pw, String name, String tel) {
        ...
        //System.out.println("id: " + id + " pw: " + pw + " name: " + name + " tel: " + tel);
        System.out.println(memberVO);

        //회원가입 결과를 html에 보내야할 것 같음.
        //html 안에서는 컨트롤러가 보낸 결과를 프린트해야할 것 같음.!

        return "create2"; //회원가입 처리 후 응답페이지
    }
    ...
    @PostMapping("read")
    public String read(int id) { //int로 만들어서 집어넣어줘 변수 id
