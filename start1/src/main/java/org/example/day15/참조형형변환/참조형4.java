...
public class 참조형4 {
    public static void main(String[] args) {
        ...
        list.add(100); //정수
        //기본형을 참조형에 넣고 싶을 때 참조형(Wrapper Class, 포장클래스)으로 만들어주면 된다.
        //자동 형변환인 경우 자동으로 해줌.
        ...
        //넣을 때는 다 모으고 싶어서 object로 형변환해서 다 집어 넣어놓음. add(object o)
        System.out.println("-------------------------------");
        //이제 꺼내보자
        ...
        //꺼내서 String 메서드를 쓸 때는 String으로 다시 만들어줘야 String 메서드를 쓸 수 있다.
