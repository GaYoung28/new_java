...
public class 크롤링테스트3 {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < names.length; i++) {
            Document doc2 =  Jsoup.connect("https://finance.naver.com/item/main.naver?code=" + codes[i]).get(); // 체인식 코드
            ...
            //고가 high에 넣기
            String high = list6.get(18).text();
            //현재가 today에 넣기
            String today = list6.get(14).text();
            //전일 yesterday에 넣기
            String yesterday = list6.get(17).text();
            //다음과 같이 프린트해보자.
            //회사명 : 삼성전자
