package org.example.quiz.variable;
...
public class basic_q3_oper {
    public static void main(String[] args) { /*
        ...
        String engscore1 = JOptionPane.showInputDialog("첫 번째 영어 점수를 입력하세요: ");
        String engscore2 = JOptionPane.showInputDialog("두 번째 영어 점수를 입력하세요: ");

        int math1 = Integer.parseInt(mathscore1);
        int math2 = Integer.parseInt(mathscore2);
        int eng1 = Integer.parseInt(engscore1);
        int eng2 = Integer.parseInt(engscore2);

        double mathAvg = (math1 + math2) / 2.0;
        double engAvg = (eng1 + eng2) / 2.0;

       // String message = JOptionPane.showMessageDialog(null, "수학 평균 점수 : ", "message");
